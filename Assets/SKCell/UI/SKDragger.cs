...
namespace SKCell
{
    ...
    public class SKDragger : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        ...
        public void OnBeginDrag(PointerEventData eventData)
        {
            ...
            {
                pointerOffset = centerOnDrag ? Vector2.zero : (Vector2)Camera.current.ScreenToWorldPoint(eventData.position) - (Vector2)transform.position;
            }
        ...
        private void FollowPointer(PointerEventData eventData)
        {
            ...
            {
                selfTF.position = (Vector2)Camera.current.ScreenToWorldPoint(eventData.position) - pointerOffset;
            }
